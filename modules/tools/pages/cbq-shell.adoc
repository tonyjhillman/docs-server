...
To access a bucket, authentication is required.
The individual user can specify their username and password to the cbq shell on startup:
...
Alternatively, the username alone can be specified: in this case, cbq prompts for the associated password:
