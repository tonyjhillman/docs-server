...
See xref:manage:manage-settings/configure-compact-settings.adoc[Configuring Auto-Compaction] for information on how to use this setting.
...
----
./couchbase-cli bucket-create --cluster 10.143.201.101:8091 \
