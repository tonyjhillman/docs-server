...
http://10.143.201.101:8091/settings/rbac/groups | jq
----
...
http://10.143.201.101:8091/settings/rbac/users/local/dgreen \
-d password=pwdpwd \
-d roles=ro_admin
----
...
----
curl -v -X PUT -u Administrator:password \
http://10.143.201.101:8091/settings/rbac/users/local/rbrown
