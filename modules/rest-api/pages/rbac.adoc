...
See xref:learn:security/authentication-domains.adoc[Authentication Domains], for an overview of local and external domains, and how to define users respectively.
